...
>
>```bash
>#Überwachung von s7comm-plus(0x72) und s7comm(0x32) 
>
>alert tcp any any -> any 102 (msg: "SCADA: Plus"; content: "|72|", offset 7, depth 1; sid: 100; rev: 1;)
>
alert tcp any any -> any 102 (msg: "SCADA: Normal"; content: "|32|", offset 7, depth 1; sid: 101; rev: 1;)
>```
>
>```bash
