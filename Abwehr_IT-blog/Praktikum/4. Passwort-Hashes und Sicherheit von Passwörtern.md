...
> Statt einer einzigen zentralen /etc/shadow-Datei existiert auf macOS pro Benutzer ein Plist-Eintrag, der verschiedene Repräsentationen der Passwortableitung enthalten kann. Diese Repräsentationensind historisch gewachsen und können je nach macOS-Version unterschiedliche Ableitungs- oder
Hashverfahren repräsentieren. Moderne macOS-Versionen bauen zusätzliche Schutzschichten ein. Je
nach Systemkonfiguration können Passwortableitungen durch Systemdienste, Hardware-Sicherheits-
module oder durch Schlüsselbund-Mechanismen ergänzt werden. Bei Systemen mit FileVault kommt
darüber hinaus die Festplattenverschlüsselung ins Spiel, deren Schlüsselverwaltung unabhängig von
den lokalen Nutzer-Hashes erfolgt.