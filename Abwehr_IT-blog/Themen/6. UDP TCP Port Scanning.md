...
>>Durch Senden von doppelten Paketen mit richtiger Sequence-Nummber an den Host können Pakete mit Offset eingefügt werden, die im TCP Stack (Window Size) des Hosts abgelegt werden:
>>
