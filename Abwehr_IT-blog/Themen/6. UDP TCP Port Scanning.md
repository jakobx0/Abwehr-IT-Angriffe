 ...
 >  ![[Pasted image 20251116114414.png | 700]]
 >
 >Grundlagen zu UDP 
...
>
>![[Pasted image 20250123121727.png | 500]]
>
...
>>
>>![[Pasted image 20251116122051.png | 590]]
>>
>>**Berechnung der neuen Seqenznummer:**
>>
>>![[Pasted image 20241106143738.png | 180]]
>
...
>>
>>![[Pasted image 20251120141831.png | 600]]
>>
...
>>>Es gibt eine Vielzahl an session Hijacking Tools und durchgeführte Angriffe mit gleichlautendem Namen:
>>>- Juggernaut
>>>- Hunt
>>>- TTY Watcher
>>>- IP Watcher
...
>>
>>![[Pasted image 20251123145107.png | 500]]
>>
>>Und die dazugehörige Befehlsreferenz:
>>
>> ![[Pasted image 20251123145205.png | 450]]
>>
>>Das von Scapy erzeugte Paket in Wireshark dargestellt:
>>
>>![[Pasted image 20251123145322.png | 550]]
>>
>>Es gibt auch eine Scapy Funktion namens arpcachepoison(), die verwendet werden kann, um eine ARP-Response mit der Angreifer MAC-Adresse und Opfer IP an das Gatway-Zielsystem zu senden:
>>
...
>>- Benutzung Sicherer Protokolle (SSH)
>>- Limitierung von Remote Zugriffsmöglichkeiten
>>- Sensibilisierung von Mitarbeitern (Manipulation von Sessions)
>
><div style="page-break-before: always;"></div>
>
>>[!bug] **Port-Scanning**
...
>>![[Pasted image 20250203124804.png | 680]]
>>
...
>>Beispiele mit nmap:
>>
>>![[Pasted image 20251120114117.png | 600]]
>>
>**OS-Fingerprinting**
>Die Erkennung entfernter Betriebssysteme durch OS Fingerprinting geschieht für gewöhnlich durch eine Analyse des TCP/IP-Stacks. Dabei werden zunächst verschiedene, speziell vorbereitete Nachrichten an das Zielsystem gesendet, die die Options Felder im TCP/IP ausnutzen. Anhand des unterschiedlichen Antwort-Verhaltens verschiedener TCP/IP-Implementierungen in verschiedenen Betriebssystemen können Rückschlüsse auf das verwendete Betriebssystem gezogen werden. Durch eine Kombination verschiedener Tests lässt sich die Treffer Wahrscheinlichkeit verbessern.
>
